...
<div class="respon">
    ...
    <!-- Todos os itens -->
    <div class="borda">
    <h2 style="text-align:center;">Armas Airsoft</h2>
    <?php
      ...
      <div class="item">
        ...
        <div class="card-body">
          ...
          <div class="item_links">
              ...
              <a class="fav" style="cursor:pointer" onclick="adicionado()" href="favorito.php?id=<?php echo $produto['id'] ?>&caminho=airsoft" id="link"  name="favorito"><i class="fas fa-cart-plus"></i></a><br><br>
          </div>
      </div>
      </div>
     </div>
...
<footer class="page-footer font-small cyan darken-3">
  ...
  crossorigin="anonymous"></script>
        <script>
        $('li.categoria h4').click(function()
            {
                $('li.categoria ul').slideToggle(); //função do jQuery
            })
        </script>
</body>
</html>
