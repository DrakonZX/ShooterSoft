...
<head>
  ...
  <title>Rifles -  ShooterSoft</title>
</head>
    ...
    <div class="caminho">
       <table>
         <tr>
           ...
           <th> <a href="rifles.php">Rifles</a> </th>
         </tr>
       </table>
    </div>
    <!-- Todos os itens -->
    <div class="borda">
    <h2 style="text-align:center;">Rifles</h2>
    <?php
      $data = date("Y");

    $sql = "SELECT * FROM produtos_airsoft WHERE categoria LIKE'%Rifle%'";
    $sql = $pdo-> query($sql);
    if ($sql -> rowCount() > 0) {
      ...
      <div class="item">
        ...
        <div class="card-body">
          ...
          <div class="item_links">
              ...
              <a class="fav" style="cursor:pointer" onclick="adicionado()" href="favorito.php?id=<?php echo $produto['id'] ?>&caminho = rifle" id="link"  name="favorito"><i class="fas fa-cart-plus"></i></a><br><br>
          </div>
      </div>
      </div>
      </div>
