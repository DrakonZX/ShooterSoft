...
<head>
  ...
  <title>Escoetas -  ShooterSoft</title>
</head>
...
<div class="caminho">
   <table>
     <tr>
       ...
       <th> <a href="escopeta.php">Escoetas</a> </th>
     </tr>
   </table>
</div>
...
<!-- Todos os itens -->
<div class="borda">
<h2 style="text-align:center;">Escopetas</h2>
<?php
  ...
  <div class="item">
    ...
    <div class="card-body">
      ...
      <div class="item_links">
          ...
          <a class="fav" style="cursor:pointer" onclick="adicionado()" href="favorito.php?id=<?php echo $produto['id'] ?>&caminho = escopeta" id="link"  name="favorito"><i class="fas fa-cart-plus"></i></a><br><br>
      </div>
  </div>
  </div>
  </div>
