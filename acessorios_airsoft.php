...
<body>
  ...
  <div class="respon">
    <div class="caminho">
       <table>
         <tr>
           ...
           <th> <a href="acessorios_airsoft.php">Acessórios airsoft</a> </th>
         </tr>
       </table>
    </div>
    ...
    <!-- Todos os itens -->
    <div class="borda">
    <h2 style="text-align:center;">Acessórios</h2>
    <?php
    $sql = "SELECT * FROM produtos_airsoft WHERE categoria LIKE '%Acessórios%'";
    $sql = $pdo-> query($sql);
    if ($sql -> rowCount() > 0) {
      ...
      <div class="item">
        ...
        <div class="comprar"><br><br><br>
          ...
          <form class="favorito" action="favorito.php?id=<?php echo $produto['id']?>&caminho=acessorios_airsoft" method="post">
