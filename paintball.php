    ...
    <div class="caminho">
       <table>
         <tr>
           ...
           <th> <a href="paintball.php">Paintball</a> </th>
         </tr>
       </table>
    </div>
    <!-- Todos os itens -->
    <div class="borda">
    <h2 style="text-align:center;">Paintball</h2>
    <?php
      $data = date("Y");
      ...
      <div class="item">
        ...
        <div class="card-body">
          ...
          <div class="item_links">
              ...
              <a class="fav" style="cursor:pointer" onclick="adicionado()" href="favorito.php?id=<?php echo $produto['id'] ?>&caminho = paintball" id="link"  name="favorito"><i class="fas fa-cart-plus"></i></a><br><br>
          </div>
      </div>
      </div>
      </div>
